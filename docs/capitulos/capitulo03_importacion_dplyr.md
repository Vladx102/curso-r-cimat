...
[← Capítulo 2d](capitulo02d_graficos_base.md) · [Índice](../../README.md) · [Capítulo 4 →](capitulo04_agregacion_tidyr_ggplot2.md)
...
10. Importa [`data/prestamos.csv`](../../data/prestamos.csv). Limpia `usuario` con stringr (espacios y mayúsculas inconsistentes) y filtra los préstamos que siguen abiertos (`fecha_devolucion` vacía). ¿Cuántos días lleva prestado el más antiguo?
