---
title: 'Capítulo 0 — Fundamentos de R: aritmética, variables y ayuda'
output:
...
# Se hace UNA SOLA VEZ por computadora, no en cada sesión (se deja
# comentada aquí para que correr este chunk no reinstale tidyverse
# cada vez que lo ejecutes o hagas knit del documento):
