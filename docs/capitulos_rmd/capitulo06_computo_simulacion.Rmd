---
title: "Capítulo 6 — Cómputo estadístico y simulación"
...
Lo mismo, con datos reales del curso (`data/clima.csv`, dos ciudades con temperatura y precipitación diaria de un año):
...
10. Usando `data/clima.csv` (`read_csv("../../data/clima.csv")`), calcula la temperatura promedio y el IQR de precipitación por ciudad (dplyr). ¿La diferencia de temperatura del `t.test()` de arriba es consistente con esos promedios?
